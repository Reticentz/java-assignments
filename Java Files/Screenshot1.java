...
public class Screenshot1 extends JFrame
{
	...
	private JTextField searchTF1, searchTF2, searchTF3, searchTF4;
	private JButton searchB, clearB, specificationB, contactB, viewB;
	private JLabel imageL, yearSL, makeSL, modelSL, yearL, makeL, modelL, costL, askPriceL, minPriceL, dataL1, dataL2, dataL3, dataL4, dataL5, dataL6, tableL, table2L, table3L, idSL, idL, dataL7;
	...
	public Screenshot1()
	{
		...
		idSL = new JLabel("<html><B>ID :</B></html>");
		...
		idL = new JLabel("ID:");
		dataL1 = new JLabel("1970");
		dataL2 = new JLabel("Dodge");
		dataL3 = new JLabel("Challenger");
		dataL4 = new JLabel("$89,000");
		dataL5 = new JLabel("$125,000");
		dataL6 = new JLabel("$100,000");
		dataL7 = new JLabel("05834");
		
		searchTF1.setText("1970");
		searchTF2.setText("Dodge");
		searchTF3.setText("Challenger");
		searchTF4.setText("05834");
		...
		idSL.setBounds(50, 100, 100, 25);
		searchTF4.setBounds(100, 100, 100, 25);
		searchB.setBounds(700, 50, 100, 25);
		clearB.setBounds(700, 100, 100, 25);
		specificationB.setBounds(75, 650, 150, 25);
		...
		askPriceL.setBounds(50, 450, 250, 50);
		minPriceL.setBounds(50, 500, 250, 50);
		idL.setBounds(50, 550, 250, 50);
		...
		dataL5.setBounds(170, 450, 250, 50);
		dataL6.setBounds(170, 500, 250, 50);
		dataL7.setBounds(170, 550, 250, 50);
	...
	{
		try{
		image = ImageIO.read(new File("CAR2.jpg"));
	...
	{
		Screenshot1 zach = new Screenshot1();
	}
}